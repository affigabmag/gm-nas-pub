 ...
 <div class="card"><h2>Apps</h2>
  ...
  <div id="stGuideWrap">
   <ul class="hint" style="list-style:none;margin:6px 0 0;padding-left:0;line-height:1.9">
    ...
    <li><label style="cursor:pointer;display:flex;align-items:center;gap:8px"><b style="flex:none;min-width:14px">4.</b><input type="checkbox" class="stStep" data-i="3" disabled style="flex:none"><span>Usually automatic: the "New device" popup above already shares the <b>syncthing</b> folder when you add it. If you added the device another way instead, open the box's <b>Syncthing admin page</b> (the "Open" button above) and share it manually.</span></label></li>
